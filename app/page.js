...
export default function Home() {
  ...
  return (
    ...
    `,
      ...
      {/* ── Navbar ── */}
      <nav
        className="sticky top-0 z-50 flex items-center justify-between px-4 sm:px-8 md:px-12 py-3.5"
        style={{
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-2 font-semibold rounded-full transition-all duration-200 cursor-pointer text-xs sm:text-sm px-4 py-2 sm:px-5 sm:py-2.5"
          style={{
            background: "#3B82F6",
            color: "#ffffff",
        ...
        >
          ...
          {/* Full text on sm+, short text on mobile */}
